...
class micro extends JFrame implements ActionListener {
    ...
    micro() {
        ...
        id8 = new JLabel("Microprocessor Marks:");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Submit) {
            ...
            try {
                // conn con = new conn();
                String str = "update details set microp='" + Mark + "' where rollno='" + roll.getText() + "' ";
                String str2 = "update teacher set microp='" + Mark + "' where rollno='" + roll.getText() + "' ";
