...
class delete extends JFrame implements ActionListener {
    ...
    JTextField roll, Rollno, name, lastname, address, phone, dob, gender;
    ...
    delete() {
        ...
        JLabel l1 = new JLabel("Enter roll number to delete the data of student:");
        ...
        select = new JButton("Fetch");
        select.setBackground(Color.BLACK);
        select.setForeground(Color.WHITE);
        select.setBounds(720, 100, 100, 30);
        n5.add(select);
        select.addActionListener(this);

        id8 = new JLabel("Delete Student Details:");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Delete) {
            ...
            try {
                ...
                String q = "delete from details where rollno= '" + Roll + "'";
                String q2 = "delete from student where rollno= '" + Roll + "'";
