...
class dbms extends JFrame implements ActionListener {
    ...
    dbms() {
        ...
        id8 = new JLabel("Database Management System Marks:");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Submit) {
            ...
            try {
                // conn con = new conn();
                String str = "update details set dbms='" + Mark + "' where rollno='" + roll.getText() + "' ";
                String str2 = "update teacher set dbms='" + Mark + "' where rollno='" + roll.getText() + "' ";
