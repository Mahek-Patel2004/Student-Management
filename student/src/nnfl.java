...
class nnfl extends JFrame implements ActionListener {
    ...
    nnfl() {
        ...
        id8 = new JLabel("Neural Network and Fuzzy Logic Marks:");
        id8.setBounds(50, 10, 1000, 50);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Submit) {
            ...
            try {
                // conn con = new conn();
                String str = "update details set nnfl='" + Mark + "' where rollno='" + roll.getText() + "' ";
                String str2 = "update teacher set nnfl='" + Mark + "' where rollno='" + roll.getText() + "' ";
