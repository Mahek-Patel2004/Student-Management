...
class cn extends JFrame implements ActionListener {
    ...
    cn() {
        ...
        id8 = new JLabel("Computer Network Marks:");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Submit) {
            ...
            try {
                // conn con = new conn();
                String str = "update details set cn_mark='" + Mark + "' where rollno='" + roll.getText() + "' ";
                String str2 = "update teacher set cn_mark='" + Mark + "' where rollno='" + roll.getText() + "' ";
